...
class Piece {
    ...
    private:
        ...
        string m_position; // initially will be set to "", chess functions will handle set up. Positions range from "A1" to "H8", where 1-8 is the y-axis and A-H is the x-axis
